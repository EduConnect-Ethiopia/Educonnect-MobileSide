...
void main() {
  final url = "https://www.youtube.com/watch?v=w9xKj5PsCnI";
  print(extractVideoId(url));
  print(extractVideoId("youtube.com/watch?v=w9xKj5PsCnI"));
  print(extractVideoId("www.youtube.com/watch?v=w9xKj5PsCnI"));
  print(extractVideoId("https://youtu.be/w9xKj5PsCnI"));
}
...
String? extractVideoId(String url) {
  ...
  bool _looksLikeVideoId(String value) {
